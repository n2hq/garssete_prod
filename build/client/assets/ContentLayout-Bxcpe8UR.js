import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as a,u as f,L as x}from"./components-kAvIA9Ge.js";import{M as g,b as v,L as w}from"./MobileNav-WD4SLO32.js";import{e as j,u as N}from"./index-BKi4tw_A.js";import{U as b,H as y}from"./Hamburger-1rpR6E2l.js";import{H as S}from"./HomeNav-T9IOjZgo.js";const k=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],L=()=>{const[l,t]=a.useState(!1),[n,s]=a.useState(!1),[c,d]=a.useState("light"),i=()=>t(!0),m=()=>t(!1),h=f();return e.jsxs("div",{children:[e.jsx("div",{className:`px-[15px] z-[10] fixed w-full
        bg-white border-b-[5px] border-green-500`,children:e.jsx("div",{className:"w-full mx-auto",children:e.jsxs("div",{className:`w-full flex place-content-between
                ...
                overflow-hidden`,children:[e.jsxs("aside",{className:`bg-gray-50 text-gray-900 
                        ...
                        `,children:l})})]})]})},z=({children:l,title:t})=>e.jsxs("div",{children:[e.jsx("div",{className:"font-semibold text-lg",children:t}),e.jsx("div",{className:`mt-4 bg-white px-[15px] pt-4 
                rounded-lg shadow-md pb-8 `,children:l})]});export{q as A,z as C};
