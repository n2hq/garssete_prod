import{j as e,L as x,r as o}from"./components-UScJPEQZ.js";import{n as u,L as h,M as m,C as f,d as p}from"./MobileNav-aPg5T7ro.js";import{U as v,H as w}from"./UserMenu-Bxj1AbP9.js";const j=({theme:a,navBg:s})=>e.jsx(e.Fragment,{children:e.jsx("div",{className:"hidden lg:flex place-items-center space-x-14 h-full ",children:u.map((t,n)=>e.jsx(x,{to:t.url,children:e.jsx("span",{className:`${a==="light"?"text-black":"text-white"}
        ...
        shadow-sm  border-b`,children:e.jsxs("div",{className:` mx-auto w-full
              ...
              `,children:[e.jsx(h,{theme:l}),e.jsx(j,{theme:l,navBg:t}),e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(v,{theme:l}),e.jsx(w,{theme:l,openNav:s,navBg:t})]})]})})},N=({theme:a})=>{const[s,t]=o.useState(!1),[n,i]=o.useState(!1),[l,r]=o.useState(a),c=()=>t(!0),d=()=>t(!1);return e.jsxs("div",{children:[e.jsx(g,{theme:a,openNav:c,navBg:n,setNavBg:i,setTheme:r,_theme:l}),e.jsx(m,{showNav:s,closeNav:d})]})},S=({children:a})=>{const[s,t]=o.useState(!0),n=()=>{t(s===!1)};return e.jsxs("div",{className:"h-screen flex flex-col relative",children:[e.jsx(N,{theme:"dark"}),e.jsx("button",{onClick:n,className:`text-xl text-white bg-blue-700 p-2 
                ...
                overflow-hidden`,children:[e.jsxs("aside",{className:`bg-gray-50 text-gray-900 
                        ...
                        `,children:a})})]})]})},L=({children:a,title:s})=>e.jsxs("div",{children:[e.jsx("div",{className:"font-bold text-lg",children:s}),e.jsx("div",{className:"mt-4 bg-white px-4 py-4 rounded-lg shadow-md",children:a})]});export{S as A,L as C};
