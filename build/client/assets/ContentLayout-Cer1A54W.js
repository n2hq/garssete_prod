import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as a,u as f,L as x}from"./components-kAvIA9Ge.js";import{W as g,M as w,b as v,L as j}from"./MobileNav-DHe2i42A.js";import{e as N,u as b}from"./index-DzYaOoqq.js";import{U as y,H as S}from"./Hamburger-D-zpFp8C.js";import{H as L}from"./HomeNav-ByIN2RW5.js";const k=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],H=()=>{const[l,t]=a.useState(!1),[n,s]=a.useState(!1),[c,d]=a.useState("light"),i=()=>t(!0),m=()=>t(!1),h=f();return e.jsxs("div",{children:[e.jsx("div",{className:`px-[15px] z-[1000] fixed w-full
        bg-white shadow-md`,children:e.jsx("div",{className:"w-full mx-auto",children:e.jsxs("div",{className:`w-full flex place-content-between
                    h-[60px] gap-x-5`,children:[e.jsx("div",{className:`flex place-items-center
                        `,children:e.jsx(x,{to:"/",children:e.jsx(g,{})})}),e.jsxs("div",{className:`flex place-items-center
