import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as a,u as f,L as u}from"./components-DN9bEK-g.js";import{U as g,H as w,M as v,c as j,L as N}from"./MobileNav-D7FcM9wJ.js";import{e as b}from"./index-BuMB8ucW.js";import{W as y}from"./WhiteLogo-D0_DZqmS.js";import{H as S}from"./HomeNav-sGChEP8Q.js";import{u as L}from"./AuthContext-Bd05mLB0.js";const k=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],H=()=>{const[n,t]=a.useState(!1),[i,s]=a.useState(!1),[x,m]=a.useState("light"),c=()=>t(!0),o=()=>t(!1),r=f();return e.jsxs("div",{children:[e.jsx("div",{className:`px-[15px] z-[1000] fixed w-full
        bg-white shadow-md`,children:e.jsx("div",{className:"w-full mx-auto",children:e.jsxs("div",{className:`w-full flex place-content-between
                    h-[60px] gap-x-5`,children:[e.jsx("div",{className:`flex place-items-center
                        `,children:e.jsx(u,{to:"/",children:e.jsx(y,{})})}),e.jsxs("div",{className:`flex place-items-center
                        gap-5 grow`,children:[e.jsx("div",{className:"w-full",children:e.jsxs("form",{action:"/web/search",className:`w-full flex rounded-full border px-1
                                ...
                                min-w-fit gap-1`,children:k.map((l,h)=>{const p=r.search,d=decodeURI(p);return console.log(d),e.jsx(u,{className:`text-[14px] hover:bg-gray-200/50
                                                px-[10px] py-[6px] rounded
                                                font-semibold
                                                ${l.lnk.toString().includes(d)&&d.toString()!==""&&"bg-green-200"}`,to:l.lnk,children:l.title},h)})})]}),e.jsxs("div",{className:`flex place-items-center
                        gap-4`,children:[e.jsx(g,{theme:"light"}),e.jsx(w,{theme:"light",openNav:c,navBg:i})]})]})})}),e.jsx(v,{showNav:n,closeNav:o})]})},E=({children:n})=>{const[t,i]=a.useState(!0),s=L(),[x,m]=a.useState(!0),c=()=>{i(t===!1)};return a.useEffect(()=>{var o,r,l;((o=s==null?void 0:s.user)==null?void 0:o.guid)!==null&&((r=s==null?void 0:s.user)==null?void 0:r.guid)!==void 0&&((l=s==null?void 0:s.user)==null?void 0:l.guid)!==""?m(!1):window.location.href="/web/signin"},[s==null?void 0:s.user]),x?e.jsx("div",{className:"flex justify-center items-center h-screen",children:e.jsx("div",{className:"text-lg",children:"Loading..."})}):e.jsxs("div",{className:"h-screen flex flex-col relative",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(S,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(H,{})}),e.jsx("button",{onClick:c,className:`text-xl text-white bg-blue-700 p-2 
