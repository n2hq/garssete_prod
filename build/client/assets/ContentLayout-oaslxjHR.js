import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as l,u as f,L as x}from"./components-kAvIA9Ge.js";import{M as g,b as v,L as w}from"./MobileNav-LIsZBRvf.js";import{e as j,u as b}from"./index-B9N273Tc.js";import{U as N,H as y}from"./Hamburger-CleV0Nrg.js";import{H as S}from"./HomeNav-yC6Wp3OK.js";const k=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],L=()=>{const[a,t]=l.useState(!1),[n,s]=l.useState(!1),[c,d]=l.useState("light"),i=()=>t(!0),m=()=>t(!1),h=f();return e.jsxs("div",{children:[e.jsx("div",{className:`px-[15px] z-[10] fixed w-full
        bg-white border-b-[5px] border-blue-500`,children:e.jsx("div",{className:"w-full mx-auto",children:e.jsxs("div",{className:`w-full flex place-content-between
                    h-[60px] gap-x-5`,children:[e.jsx("div",{className:`flex place-items-center
                        ...
                        gap-4`,children:[e.jsx(N,{theme:"light"}),e.jsx(y,{theme:"light",openNav:i,navBg:n})]})]})})}),e.jsx(g,{showNav:a,closeNav:m})]})},q=({children:a})=>{const[t,n]=l.useState(!0),{user:s}=b(),[c,d]=l.useState(!0),i=()=>{n(t===!1)};return l.useEffect(()=>{(s==null?void 0:s.guid)!==null&&(s==null?void 0:s.guid)!==void 0&&(s==null?void 0:s.guid)!==""?d(!1):window.location.href="/web/signin"},[s]),c?e.jsx("div",{className:"flex justify-center items-center h-screen",children:e.jsx("div",{className:"text-lg",children:"Loadings..."})}):e.jsxs("div",{className:"h-screen flex flex-col relative",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(S,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(L,{})}),e.jsx("button",{onClick:i,className:`text-xl text-white bg-blue-700 p-2 
