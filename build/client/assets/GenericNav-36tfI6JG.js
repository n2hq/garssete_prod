import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r,u as p,L as d}from"./components-kAvIA9Ge.js";import{B as h}from"./index-WKNWlyJ5.js";import{H as u}from"./Hamburger-CJc3nZ7T.js";import{M as f}from"./MobileNav-sL5bwZn0.js";import{U as g}from"./UserMenu-DmWssK1n.js";import{W as w}from"./WhiteLogo-rEYCCE-c.js";const v=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],U=()=>{const[n,l]=r.useState(!1),[c,j]=r.useState(!1),[b,N]=r.useState("light"),o=()=>l(!0),i=()=>l(!1),s=p(),m=new URLSearchParams(s.search).get("q")||"";return e.jsxs("div",{children:[e.jsx("div",{className:`px-[10px] z-[10] fixed w-full
        bg-white border-b-[5px] border-green-500`,children:e.jsx("div",{className:"max-w-[1100px] mx-auto w-full",children:e.jsxs("div",{className:`w-full flex place-content-between
                    h-[60px] gap-x-2`,children:[e.jsx("div",{className:`flex place-items-center
                        ...
                        gap-1 md:gap-4`,children:[e.jsx(g,{theme:"light"}),e.jsx(u,{theme:"light",openNav:o,navBg:c})]})]})})}),e.jsx(f,{showNav:n,closeNav:i}),e.jsx("div",{className:"h-[65px] "})]})};export{U as G};
