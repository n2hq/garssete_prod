import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as a,u as p,L as h}from"./components-DN9bEK-g.js";import{e as d}from"./index-BuMB8ucW.js";import{U as u,H as f,M as g}from"./MobileNav-D7FcM9wJ.js";import{W as w}from"./WhiteLogo-D0_DZqmS.js";const v=[{title:"Search",lnk:"/web/search"},{title:"Hotels",lnk:"/web/search?q=hotels"},{title:"Travel",lnk:"/web/search?q=travel"}],H=()=>{const[n,l]=a.useState(!1),[c,j]=a.useState(!1),[N,b]=a.useState("light"),i=()=>l(!0),o=()=>l(!1),s=p(),x=new URLSearchParams(s.search).get("q")||"";return e.jsxs("div",{children:[e.jsx("div",{className:`px-[10px] z-[10] fixed w-full
        bg-white shadow-md `,children:e.jsx("div",{className:"max-w-[1100px] mx-auto w-full",children:e.jsxs("div",{className:`w-full flex place-content-between
                    h-[60px] gap-x-2`,children:[e.jsx("div",{className:`flex place-items-center text-black
                        ...
                        gap-1 md:gap-4`,children:[e.jsx(u,{theme:"light"}),e.jsx(f,{theme:"light",openNav:i,navBg:c})]})]})})}),e.jsx(g,{showNav:n,closeNav:o}),e.jsx("div",{className:"h-[65px] "})]})};export{H as G};
