import{r as t,j as e}from"./components-UScJPEQZ.js";import{L as p,M as v}from"./MobileNav-CZmBy4tC.js";const u=({theme:n,openNav:c,navBg:l,setNavBg:i,setTheme:a,_theme:o})=>{const[s]=t.useState(1);return t.useEffect(()=>{const r=()=>{window.scrollY>=s&&a("dark"),window.scrollY<s&&a("light")};window.onscroll=()=>r()},[s]),e.jsx("div",{className:`${o==="dark"?"bg-gray-800":"bg-white"}
