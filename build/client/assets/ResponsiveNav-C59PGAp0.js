import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as t}from"./components-kAvIA9Ge.js";import{W as p,M as v}from"./MobileNav-DY-9MUaW.js";const f=({theme:o,openNav:i,navBg:n,setNavBg:c,setTheme:a,_theme:r})=>{const[s]=t.useState(1);return t.useEffect(()=>{const l=()=>{window.scrollY>=s&&a("dark"),window.scrollY<s&&a("light")};window.onscroll=()=>l()},[s]),e.jsx("div",{className:`${r==="dark"?"bg-gray-800":"bg-white"}
