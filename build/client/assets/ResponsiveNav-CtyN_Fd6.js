import{j as s}from"./jsx-runtime-0DLF9kdB.js";import{r as t}from"./components-kAvIA9Ge.js";import{W as w,M as x}from"./MobileNav-CLmV9V7l.js";import{w as d}from"./css-DPrdeFsB.js";const f=({theme:a,openNav:c,navBg:l,setNavBg:p,setTheme:o,_theme:n})=>{const[e,r]=t.useState(1);return t.useEffect(()=>{const i=()=>{window.scrollY>=e&&o("dark"),window.scrollY<e&&o("light"),r(window.scrollY)};window.onscroll=()=>i()},[e]),s.jsx("div",{className:`${e>10?"shadow-md":""}
        ${n&&"bg-white"}
