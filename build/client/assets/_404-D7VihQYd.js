import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{r as a,L as x,u as h}from"./components-kAvIA9Ge.js";import{U as m,H as p}from"./Hamburger-hmQTJRQN.js";import{M as u}from"./MobileNav-yHOKq_Ak.js";import"./index-B9N273Tc.js";import"./index-CRnWyQgj.js";const f=({theme:t})=>{const[c,s]=a.useState("light");return a.useEffect(()=>{s(t)},[t,c]),e.jsxs("div",{className:"flex place-items-center space-x-1",children:[e.jsx(x,{to:"/",children:e.jsx("div",{className:`${t==="light"?"bg-black text-white":"bg-white/90 text-black"}
        ...
        transition ease-in-out duration-0`,children:e.jsxs("div",{className:`max-w-[1100px] mx-auto w-full gap-5
              ...
              `,children:[e.jsx(f,{theme:l}),e.jsx("div",{className:" w-full",children:e.jsx(v,{theme:l,navBg:s})}),e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(m,{theme:l}),e.jsx(p,{theme:l,openNav:c,navBg:s})]})]})})},b=({theme:t})=>{const[c,s]=a.useState(!1),[r,n]=a.useState(!1),[l,i]=a.useState(t),o=()=>s(!0),d=()=>s(!1);return e.jsxs("div",{children:[e.jsx(j,{theme:t,openNav:o,navBg:r,setNavBg:n,setTheme:i,_theme:l}),e.jsx(u,{showNav:c,closeNav:d})]})};function E(){return e.jsxs("div",{children:[e.jsx(b,{theme:"dark"}),e.jsx("div",{className:`min-h-screen flex items-center justify-center 
