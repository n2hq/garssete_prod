import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{u as d,L as p,r as c}from"./components-kAvIA9Ge.js";import{L as m}from"./Logo-Bqbb4Qu7.js";import{H as u}from"./Hamburger-CJc3nZ7T.js";import{U as h}from"./UserMenu-DmWssK1n.js";import{M as f}from"./MobileNav-sL5bwZn0.js";import"./WhiteLogo-rEYCCE-c.js";import"./index-WKNWlyJ5.js";import"./index-B5TRE6qw.js";import"./index-D1npojxj.js";const j=[{label:"Page Search",url:"/web/search"}],v=({theme:r,navBg:o})=>{const t=d();return e.jsx(e.Fragment,{children:e.jsx("div",{className:"hidden lg:flex place-items-center space-x-14 h-full ",children:j.map((a,l)=>e.jsx(p,{to:a.url,children:e.jsx("span",{className:`text-black
        ...
        transition ease-in-out duration-0`,children:e.jsxs("div",{className:`max-w-[1100px] mx-auto w-full gap-5
              ...
              `,children:[e.jsx(m,{theme:s}),e.jsx("div",{className:" w-full",children:e.jsx(v,{theme:s,navBg:t})}),e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(h,{theme:s}),e.jsx(u,{theme:s,openNav:o,navBg:t})]})]})})},b=({theme:r})=>{const[o,t]=c.useState(!1),[a,l]=c.useState(!1),[s,n]=c.useState(r),i=()=>t(!0),x=()=>t(!1);return e.jsxs("div",{children:[e.jsx(g,{theme:r,openNav:i,navBg:a,setNavBg:l,setTheme:n,_theme:s}),e.jsx(f,{showNav:o,closeNav:x})]})};function $(){return e.jsxs("div",{children:[e.jsx(b,{theme:"dark"}),e.jsx("div",{className:`min-h-screen flex items-center justify-center 
        text-center px-4 text-black`,children:e.jsxs("div",{className:`flex place-content-center place-items-center gap-3
                h-[50px]`,children:[e.jsx("div",{className:`text-2xl font-bold text-red-600 h-full
                    ...
                    h-full flex place-items-center`,children:"This page could not be found."})]})})]})}export{$ as default};
