import{j as e,L as o,r as l}from"./components-RujwakfW.js";import{n as c,L as i,H as x,M as d,S as h}from"./MobileNav-Buy9zZV8.js";import"./index-DJx9Xc4x.js";const m=({navBg:a})=>e.jsx(e.Fragment,{children:e.jsx("div",{className:"hidden lg:flex place-items-center space-x-14 h-full ",children:c.map((t,s)=>e.jsx(o,{to:t.url,children:e.jsx("span",{className:`text-white
        ...
        transition-all ease-in-out duration-0`,children:e.jsxs("div",{className:`max-w-[1100px] mx-auto w-full
              ...
              `,children:[e.jsx(i,{theme:"dark"}),e.jsx(m,{navBg:t}),e.jsx("div",{children:e.jsx(x,{openNav:a,navBg:t})})]})})},p=()=>{const[a,t]=l.useState(!1),[s]=l.useState(!1),n=()=>t(!0),r=()=>t(!1);return e.jsxs("div",{children:[e.jsx(f,{openNav:n,navBg:s}),e.jsx(d,{showNav:a,closeNav:r})]})},u=()=>e.jsxs("div",{className:`w-full h-screen bg-[#0f0715] overflow-hidden
        relative bg-[url('/images/hero.jpg')] bg-cover bg-center`,children:[e.jsx("div",{className:" absolute inset-0 bg-black opacity-50"}),e.jsxs("div",{className:`flex justify-center items-center flex-col
                ...
                `,children:[e.jsx("h1",{className:`text-white text-center
                    ...
                    text-gray-200 font-sans font-light`,children:"More than 745,000 businesses, places & people."}),e.jsx("div",{className:"mt-6 w-full",children:e.jsx(h,{})}),e.jsx("div",{className:`text-white mt-[10px] text-[12px] text-center
                      max-w-[800px] w-full px-[50px]`,children:"Get to know and visit the best of local businesses across the globe. Smartest way to find and be found."})]})]}),v=()=>e.jsx("div",{className:"overflow-hidden",children:e.jsx(u,{})}),N=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function b(){return e.jsxs("div",{children:[e.jsx(p,{}),e.jsx(v,{})]})}export{b as default,N as meta};
