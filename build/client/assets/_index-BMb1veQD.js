          ...
          `,children:o==null?void 0:o.map((s,x)=>e.jsxs("div",{className:`w-full h-full block 
                ...
                place-items-center px-[15px] bg-black/20`}),e.jsxs("div",{className:`z-[300] absolute 
                                         w-full text-center top-[40%]
                                          text-white 
                                         px-[20px] py-[10px] `,children:[e.jsx("div",{className:"text-[13px]",children:s.topTitle}),e.jsx("div",{className:`text-[22px] mt-[10px]
