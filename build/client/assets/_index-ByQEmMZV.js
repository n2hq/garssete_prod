import{j as e,L as o,r as l}from"./components-YbiUyo11.js";import{n as i,L as c,a as x,M as d,S as h}from"./MobileNav-fSkQ8WY_.js";import"./index-TpmEskWj.js";const m=({navBg:n})=>e.jsx(e.Fragment,{children:e.jsx("div",{className:"hidden lg:flex place-items-center space-x-14 h-full ",children:i.map((t,s)=>e.jsx(o,{to:t.url,children:e.jsx("span",{className:`text-white
        ...
        transition-all ease-in-out duration-0`,children:e.jsxs("div",{className:`max-w-[1100px] mx-auto w-full
              ...
              `,children:[e.jsx(c,{theme:"dark"}),e.jsx(m,{navBg:t}),e.jsx(x,{openNav:n,navBg:t})]})})},p=()=>{const[n,t]=l.useState(!1),[s]=l.useState(!1),a=()=>t(!0),r=()=>t(!1);return e.jsxs("div",{children:[e.jsx(f,{openNav:a,navBg:s}),e.jsx(d,{showNav:n,closeNav:r})]})},u=()=>e.jsxs("div",{className:`w-full h-screen bg-[#0f0715] overflow-hidden
