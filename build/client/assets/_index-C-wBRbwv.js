import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as N}from"./HomeNav-CpLui92B.js";import{r as t,L as w}from"./components-kAvIA9Ge.js";import{U as k,H as S}from"./Hamburger-D1YOVBs3.js";import{W as y,M as z,C as R}from"./MobileNav-DPPAZEV-.js";import{B as v,a as j,b as T,c as C,d as B,M as E}from"./index-GByQRoqj.js";import{S as H,G,R as D}from"./Recents-CJEg9m5S.js";import{F as M}from"./index-ByWTzbAh.js";import{R as q}from"./index-DxLW_S-M.js";import{F}from"./LatestStarRating-g5zTjiNI.js";const L=()=>{const[n]=t.useState(1),[i,a]=t.useState(""),[o,r]=t.useState(!1),[c,u]=t.useState(!1),[m,x]=t.useState(!1),l=()=>u(!0),d=()=>u(!1);return t.useEffect(()=>{const h=()=>{window.scrollY>=n&&r(!0),window.scrollY<n&&r(!1)};window.onscroll=()=>h()},[n]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
     ...
     `,children:e.jsxs("div",{className:`max-w-[1100px] 
      mx-auto w-full text-white 
        flex place-content-between h-full gap-x-8`,children:[e.jsx("div",{className:`font-bold font-sans 
          ...
          bg-gradient-to-b
     from-black/60 to-transparent`}),e.jsxs("div",{className:"z-[300]",children:[e.jsx("button",{onMouseDown:x,className:`block absolute top-0 bottom-0 
          ...
          max-w-[800px] mx-auto w-full z-[300]`,children:e.jsx(H,{})})})]})})},A=[{title:"Restaurants",link:"/web/search?q=restaurants",icon:e.jsx(q,{})},{title:"Shopping",link:"/web/search?q=shopping",icon:e.jsx(R,{})},{title:"Nightlife",link:"/web/search?q=nightlife",icon:e.jsx(G,{})},{title:"Active Life",link:"/web/search?q=nightlife",icon:e.jsx(T,{})},{title:"Beauty & Spa",link:"/web/search?q=beauty and spa",icon:e.jsx(C,{})},{title:"Automotive",link:"/web/search?q=automotive",icon:e.jsx(M,{})},{title:"Home Services",link:"/web/search?q=home service",icon:e.jsx(B,{})},{title:"Real Estate",link:"/web/search?q=real estate",icon:e.jsx(E,{})}],P=()=>e.jsx("div",{className:"w-full relative mt-[50px] px-[15px]",children:e.jsxs("div",{className:"max-w-[1100px] mx-auto w-full",children:[e.jsx("div",{className:`relative font-sans text-2xl
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          `,children:o==null?void 0:o.map((s,p)=>e.jsxs("div",{className:`w-full h-full block 
                                        ...
                                        duration-1000 `,onTouchStart:u,onTouchEnd:m,style:{transform:`translateX(-${n*100}%)`},children:[e.jsx("img",{src:s.img,alt:"",className:`object-cover w-full h-full 
                                            z-[20]
                                        `},p),e.jsx("div",{className:`z-100 absolute top-0 w-full 
                h-[280px] md:h-[500px] flex place-content-center
                place-items-center px-[15px] bg-black/20`}),e.jsxs("div",{className:`z-[300] absolute 
                                         w-full text-center top-[33%]
                                          text-white 
                                         px-[40px] py-[10px] `,children:[e.jsx("div",{className:"text-[13px]",children:s.topTitle}),e.jsx("div",{className:`text-[22px] mt-[0px]
                                            leading-[1.2em] font-bold`,children:s.title})]})]}))}),e.jsxs("div",{className:"z-[300]",children:[e.jsx("button",{onMouseDown:h,className:`block absolute top-0 bottom-0 
                        z-[300] p-[1rem] cursor-pointer left-0 group h-full 
            ...
            flex place-content-center place-items-center group-hover:bg-white/30
            z-[300]   transition duration-500 ease-in-out
            relative `,children:e.jsx(j,{className:" stroke-white fill-black w-[2rem] h-[2rem]"})})})]})]})})},ee=()=>[{title:"Grüthe | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Gr<i>ü</i>the",content:"Welcome to Grüthe!"}],te=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(N,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(L,{})}),e.jsx("div",{className:"md:hidden",children:e.jsx(I,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx($,{})}),e.jsx(D,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(P,{}),e.jsx(F,{})]});export{te as default,ee as meta};
