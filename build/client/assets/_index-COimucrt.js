import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as v}from"./HomeNav-D8OQztua.js";import{L as f,r as t}from"./components-kAvIA9Ge.js";import{h as b,B as N,a as k,E as S,c as R,F as y,d as B,M as E}from"./index-Bk8KN62v.js";import{U as T,H as _}from"./Hamburger-De3YMqj-.js";import{M as H,C as z}from"./MobileNav-3AC4s-2C.js";import{S as C,G as M,R as q}from"./Recents-DzQ36d23.js";import{R as F}from"./index-CAWBM3Le.js";import{F as L}from"./LatestStarRating-BQw4FIBj.js";const D=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:`font-[900] text-[24px]
                cursor-pointer tracking-tight relative
                top-[-1px] `,children:b()})}),G=()=>{const[a]=t.useState(1),[l,d]=t.useState(""),[n,i]=t.useState(!1),[r,o]=t.useState(!1),[m,j]=t.useState(!1),p=()=>o(!0),u=()=>o(!1);return t.useEffect(()=>{const x=()=>{window.scrollY>=a&&i(!0),window.scrollY<a&&i(!1)};window.onscroll=()=>x()},[a]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        flex place-content-between h-full`,children:[e.jsx("div",{className:`font-bold font-sans 
          flex place-items-center text-2xl w-[100px]
           `,children:e.jsx(D,{})}),e.jsx("div",{className:`hidden place-items-center
                     lg:flex  w-full`,children:e.jsx(f,{to:"/web/search",children:"Search"})}),e.jsx("div",{className:"flex place-items-center ",children:e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(T,{theme:"dark"}),e.jsx(_,{theme:"dark",openNav:p,navBg:m})]})})]})}),e.jsx(H,{showNav:r,closeNav:u})]})},h=[{img:"https://spotlightthe.me/supercharged/wp-content/uploads/sites/18/demo-image-00013.jpg"},{img:"https://smartmag.theme-sphere.com/rtl/wp-content/uploads/sites/34/2022/11/Depositphotos_410258952_XL-1.jpg"},{img:"https://smartmag.theme-sphere.com/news/wp-content/uploads/sites/11/2021/02/daniel-korpai-seLBnDRB6_M-unsplash-1-scaled.jpg"},{img:"https://demo.tagdiv.com/newspaper_free_news_pro/wp-content/uploads/2023/12/3.jpg"},{img:"https://demo.tagdiv.com/newspaper_free_news_pro/wp-content/uploads/2023/12/2.jpg"},{img:"https://smartmag.theme-sphere.com/trendy/wp-content/uploads/sites/5/2017/01/shutterstock_275843885.jpg"},{img:"https://smartmag.theme-sphere.com/trendy/wp-content/uploads/sites/5/2017/01/shutterstock_362198879.jpg"},{img:"https://smartmag.theme-sphere.com/social-life/wp-content/uploads/sites/17/2021/02/deanna-alys-xQwRvghauaU-unsplash-1.jpg"}],X=()=>{const[a,l]=t.useState(0),d=t.useRef(0);t.useRef(0);const[n,i]=t.useState(null);let r=t.useRef(null);const o=s=>{d.current=s.touches[0].clientX},m=s=>{const c=s.changedTouches[0].clientX,w=d.current-c;w>50?l(g=>(g+1)%h.length):w<-50&&l(g=>(g-1+h.length)%h.length)};t.useEffect(()=>{i(h)},[]);const j=()=>{l(s=>s===0?n.length-1:s-1)},p=()=>{l(s=>s===n.length-1?0:s+1)},u=async()=>{r.current&&clearTimeout(r.current),p(),r.current=setTimeout(()=>{},15e3)},x=async()=>{r.current&&clearTimeout(r.current),j(),r.current=setTimeout(()=>{},15e3)};return t.useEffect(()=>{},[n]),e.jsx(e.Fragment,{children:e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:` w-full h-screen flex 
