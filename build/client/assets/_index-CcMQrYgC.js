import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as v}from"./HomeNav-aEovIiAp.js";import{L as f,r as t}from"./components-kAvIA9Ge.js";import{h as b,B as N,a as k,J as S,c as R,F as y,d as B,M as T}from"./index-BXHtOMuL.js";import{U as _,H as E}from"./Hamburger-D7h4OXGR.js";import{M as H,C as z}from"./MobileNav-DSoEjn7G.js";import{S as M,G as C,R as q}from"./Recents-C6v0rflE.js";import{R as F}from"./index-MiZpCUvU.js";import{F as L}from"./LatestStarRating-CfQPwXoS.js";const D=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:`font-[900] text-[24px]
                cursor-pointer tracking-tight relative
                top-[-1px] `,children:b()})}),G=()=>{const[a]=t.useState(1),[i,h]=t.useState(""),[n,l]=t.useState(!1),[r,o]=t.useState(!1),[m,j]=t.useState(!1),p=()=>o(!0),x=()=>o(!1);return t.useEffect(()=>{const u=()=>{window.scrollY>=a&&l(!0),window.scrollY<a&&l(!1)};window.onscroll=()=>u()},[a]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
      ...
      mx-auto w-full text-white relative gap-x-3
        flex place-content-between h-full`,children:[e.jsx("div",{className:`font-bold font-sans 
          ...
          `,children:n==null?void 0:n.map((s,c)=>e.jsx("div",{className:`w-full h-full block 
            ...
            z-[300] transition duration-500 ease-in-out relative `,children:e.jsx(N,{className:" stroke-white fill-black w-[2rem] h-[2rem]"})})}),e.jsx("button",{onMouseDown:x,className:`block absolute top-0 bottom-0 
