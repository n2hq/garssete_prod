import{j as e,L as o,r as l}from"./components-UScJPEQZ.js";import{n as i,L as c,M as x}from"./MobileNav-Xai8Apa9.js";import{U as m,H as d}from"./UserMenu-CX6q_oAm.js";import{S as h}from"./SearchBox-zAwg0FZa.js";import"./index-BFtw7xUU.js";import"./index-BFHGu91Q.js";import"./AuthContext-Buh7__Fl.js";const p=({navBg:a})=>e.jsx(e.Fragment,{children:e.jsx("div",{className:"hidden lg:flex place-items-center space-x-14 h-full ",children:i.map((t,s)=>e.jsx(o,{to:t.url,children:e.jsx("span",{className:`text-white
        ...
        transition-all ease-in-out duration-0`,children:e.jsxs("div",{className:`max-w-[1100px] mx-auto w-full
              ...
              `,children:[e.jsx(c,{theme:"dark"}),e.jsx(p,{navBg:t}),e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(m,{theme:"dark"}),e.jsx(d,{theme:"dark",openNav:a,navBg:t})]})]})})},u=()=>{const[a,t]=l.useState(!1),[s]=l.useState(!1),n=()=>t(!0),r=()=>t(!1);return e.jsxs("div",{children:[e.jsx(f,{openNav:n,navBg:s}),e.jsx(x,{showNav:a,closeNav:r})]})},v=()=>e.jsxs("div",{className:`w-full h-screen bg-[#0f0715] overflow-hidden
        relative bg-[url('/images/hero.jpg')] bg-cover bg-center`,children:[e.jsx("div",{className:" absolute inset-0 bg-black opacity-50"}),e.jsxs("div",{className:`flex justify-center items-center flex-col
                ...
                `,children:[e.jsx("h1",{className:`text-white text-center
                    ...
                    text-gray-200 font-sans font-light`,children:"More than 745,000 businesses, places & people."}),e.jsx("div",{className:"mt-6 w-full",children:e.jsx(h,{})}),e.jsx("div",{className:`text-white mt-[10px] text-[12px] text-center
                      max-w-[800px] w-full px-[50px]`,children:"Get to know and visit the best of local businesses across the globe. Smartest way to find and be found."})]})]}),j=()=>e.jsx("div",{className:"overflow-hidden",children:e.jsx(v,{})}),B=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function H(){return e.jsxs("div",{children:[e.jsx(u,{}),e.jsx(j,{})]})}export{H as default,B as meta};
