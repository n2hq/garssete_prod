import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-B2IzywPC.js";import{U as j,M as v,G as N}from"./UserMenu-aw89kR6T.js";import{C as k,F as S}from"./lib-C9YTZDIR.js";import{B as R,a as y,b as B,c as z,d as C}from"./index-CAF78CL6.js";import{M as q}from"./index-C_8kZ5ES.js";import{r as t,L as h}from"./components-DN9bEK-g.js";import{R as H}from"./index-pqH5RIoe.js";import{H as E}from"./Hamburger-Dsp2-O9s.js";import{W as F}from"./WhiteLogo-CuvdFZiF.js";import"./LatestStarRating-Ea1x6j8P.js";import"./AuthContext-D27PVHz_.js";const V=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function Z(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[r]=t.useState(1),[o,l]=t.useState(""),[m,a]=t.useState(!1),[x,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const d=()=>{window.scrollY>=r&&a(!0),window.scrollY<r&&a(!1)};window.onscroll=()=>d()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
