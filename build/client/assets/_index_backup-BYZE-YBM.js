import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-UxFrQrRP.js";import{U as j,M as v,G as N}from"./UserMenu-Dwi6NMN0.js";import{C as k,F as S}from"./lib-D3V1-_xT.js";import{B as R,a as y,b as B,c as z,d as C}from"./index-CTbeVz01.js";import{M as q}from"./index-aaHDQ7n8.js";import{r as t,L as h}from"./components-_iSq0a46.js";import{R as H}from"./index-IMbIR-_2.js";import{H as E}from"./Hamburger-CLBRwDzY.js";import{W as F}from"./WhiteLogo-CgiFAK2a.js";import"./LatestStarRating-jlpcR0a0.js";import"./AuthContext-Di_kKw7g.js";const V=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function Z(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[r]=t.useState(1),[o,l]=t.useState(""),[m,a]=t.useState(!1),[x,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const d=()=>{window.scrollY>=r&&a(!0),window.scrollY<r&&a(!1)};window.onscroll=()=>d()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
