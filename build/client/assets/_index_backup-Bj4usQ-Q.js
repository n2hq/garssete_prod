import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,S as b,G as w}from"./Recents-CyOGMWDw.js";import{W as j,M as v,C as N}from"./MobileNav-CLmV9V7l.js";import{B as k,a as S,b as R,c as y,F as B,d as z,M as C}from"./index-DH32Dgz8.js";import{r as t,L as h}from"./components-kAvIA9Ge.js";import{R as q}from"./index-B4Ex_HPM.js";import{U as H,H as E}from"./Hamburger-DiDLOwFG.js";import{F}from"./LatestStarRating-DMCsJO0Z.js";const J=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function K(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(F,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:A.map((l,o)=>e.jsx("div",{children:e.jsx(h,{to:`${l.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:l.title})]})})},o))})]})});export{K as default,J as meta};
