import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-D8JeLjWo.js";import{U as j,M as v,C as N,G as k}from"./UserMenu-BbFVfLAm.js";import{B as S,a as R,b as y,c as B,d as z}from"./index-BIKCC_L0.js";import{F as C}from"./lib-D-0hsGfR.js";import{M as q}from"./index-C8w5bx1J.js";import{r as t,L as h}from"./components-DN9bEK-g.js";import{R as H}from"./index-Bgt__CXJ.js";import{H as E}from"./Hamburger-BNuu32pj.js";import{W as F}from"./WhiteLogo-BeyFQx_H.js";import"./LatestStarRating-BeKgg9Cm.js";import"./index-Duat3q1I.js";import"./AuthContext-DrneX9gk.js";const Z=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function _(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[r]=t.useState(1),[o,l]=t.useState(""),[m,a]=t.useState(!1),[x,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const d=()=>{window.scrollY>=r&&a(!0),window.scrollY<r&&a(!1)};window.onscroll=()=>d()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:A.map((r,o)=>e.jsx("div",{children:e.jsx(h,{to:`${r.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:r.title})]})})},o))})]})});export{_ as default,Z as meta};
