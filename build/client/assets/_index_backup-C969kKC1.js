import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-DQcG5hcA.js";import{U as j,H as v,M as N,C as k,G as S}from"./UserMenu-CnuPIl-W.js";import{B as R,a as y,b as B,c as z,d as C}from"./index-TQUiWdzl.js";import{F as q}from"./lib-Ddo6mlOM.js";import{M as H}from"./index-BkU2dnIz.js";import{r as t,L as h}from"./components-DN9bEK-g.js";import{R as E}from"./index-MkRal4zH.js";import{W as F}from"./WhiteLogo-CBJbnFuS.js";import"./LatestStarRating-D2KbueAY.js";import"./index-3pbSN0sp.js";import"./AuthContext-Cppis7Ha.js";const V=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function Z(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[r]=t.useState(1),[o,l]=t.useState(""),[m,a]=t.useState(!1),[x,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const d=()=>{window.scrollY>=r&&a(!0),window.scrollY<r&&a(!1)};window.onscroll=()=>d()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
     ...
     from-black/60 to-transparent`}),e.jsxs("div",{className:"z-[300]",children:[e.jsx("button",{onMouseDown:u,className:`block absolute top-0 bottom-0 
          ...
          max-w-[800px] mx-auto w-full z-[300]`,children:e.jsx(w,{})})})]})})},A=[{title:"Restaurants",link:"/web/search?q=restaurants",icon:e.jsx(E,{})},{title:"Shopping",link:"/web/search?q=shopping",icon:e.jsx(k,{})},{title:"Nightlife",link:"/web/search?q=nightlife",icon:e.jsx(S,{})},{title:"Active Life",link:"/web/search?q=nightlife",icon:e.jsx(B,{})},{title:"Beauty & Spa",link:"/web/search?q=beauty and spa",icon:e.jsx(z,{})},{title:"Automotive",link:"/web/search?q=automotive",icon:e.jsx(q,{})},{title:"Home Services",link:"/web/search?q=home service",icon:e.jsx(C,{})},{title:"Real Estate",link:"/web/search?q=real estate",icon:e.jsx(H,{})}],G=()=>e.jsx("div",{className:"w-full relative mt-[50px] px-[15px]",children:e.jsxs("div",{className:"max-w-[1100px] mx-auto w-full",children:[e.jsx("div",{className:`relative font-sans text-2xl
