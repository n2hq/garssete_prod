import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-B0u7QRKR.js";import{B as j,a as v,R as N,C as k,G as S,b as R,c as y,F as B,d as z,M as C}from"./lib-CiZsJ3ya.js";import{r as t,L as h}from"./components-BgCvqN9p.js";import{W as q,U as H,M as E}from"./UserMenu-DOvFpcHO.js";import{H as F}from"./Hamburger-CWHE6czs.js";import"./LatestStarRating-DrvMWhle.js";import"./AuthContext-Ch7_A212.js";import"./index-DdGNG7cx.js";const K=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function O(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
