import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-veC7nAsn.js";import{U as j,M as v,G as N}from"./UserMenu-DBTDsr8H.js";import{C as k,F as S}from"./lib-BAntKQIv.js";import{B as R,a as y,b as B,c as z,d as C}from"./index-Bkgnt-Ax.js";import{M as q}from"./index-BbNtmRh-.js";import{r as t,L as h}from"./components-CooaLra5.js";import{R as H}from"./index-6Bge8BTM.js";import{H as E}from"./Hamburger-CbtBt3Bd.js";import{W as F}from"./WhiteLogo-Ds6DDdeZ.js";import"./LatestStarRating-NwGnPPCL.js";import"./AuthContext-CBoD9vfH.js";const V=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function Z(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[r]=t.useState(1),[o,l]=t.useState(""),[m,a]=t.useState(!1),[x,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const d=()=>{window.scrollY>=r&&a(!0),window.scrollY<r&&a(!1)};window.onscroll=()=>d()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
