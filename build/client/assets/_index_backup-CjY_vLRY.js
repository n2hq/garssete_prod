import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,S as b,G as w}from"./Recents-dpt1S2XY.js";import{W as j,M as v,C as N}from"./MobileNav-CNMSh4Ed.js";import{B as k,a as S,b as R,c as y,d as B,M as z}from"./index-BKi4tw_A.js";import{F as C}from"./index-hJsRv-pT.js";import{r as t,L as h}from"./components-kAvIA9Ge.js";import{R as q}from"./index-CE541MyU.js";import{U as H,H as E}from"./Hamburger-LlKeDD2z.js";import{F}from"./LatestStarRating-CZ2SRJQg.js";const K=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function O(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(F,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
