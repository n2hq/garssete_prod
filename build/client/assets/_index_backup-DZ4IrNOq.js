import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,S as b,G as w}from"./Recents-D6EmOiMc.js";import{W as j,M as v,C as N}from"./MobileNav-DjzFxtrF.js";import{B as k,a as S,b as R,c as y,d as B,M as z}from"./index-GByQRoqj.js";import{F as C}from"./index-ByWTzbAh.js";import{r as t,L as h}from"./components-kAvIA9Ge.js";import{R as q}from"./index-DxLW_S-M.js";import{U as H,H as E}from"./Hamburger-BKkoSaLB.js";import{F}from"./LatestStarRating-BGkXoTI1.js";const K=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function O(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(F,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
     ...
     `,children:e.jsxs("div",{className:`max-w-[1100px] 
      mx-auto w-full text-white 
        flex place-content-between h-full gap-x-8`,children:[e.jsx("div",{className:`font-bold font-sans 
          flex place-items-center text-2xl`,children:e.jsx(j,{})}),e.jsx("div",{className:`hidden place-items-center
          w-full lg:flex`,children:e.jsx(h,{to:"/web/search",children:"Search"})}),e.jsx("div",{className:"flex place-items-center",children:e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(H,{theme:"dark"}),e.jsx(E,{theme:"dark",openNav:s,navBg:c})]})})]})}),e.jsx(v,{showNav:d,closeNav:i})]})},L=[{img:"images/dubai7star.jpeg"},{img:"https://r4.wallpaperflare.com/wallpaper/791/501/238/new-york-city-buildings-wallpaper-51351344a10dae2b3cd90e3cb71d503d.jpg"},{img:"https://c0.wallpaperflare.com/path/494/492/40/signage-brand-cyan-yellow-5d1465fafe2d1f3e8deff1bbe07c71ce.jpg"}],T=()=>{const[l,o]=t.useState(0);t.useRef(0),t.useRef(0);const[r,x]=t.useState(null);let a=t.useRef(null);t.useEffect(()=>{x(L)},[]);const d=()=>{o(s=>s===0?r.length-1:s-1)},n=()=>{o(s=>s===r.length-1?0:s+1)},c=async()=>{a.current&&clearTimeout(a.current),n(),a.current=setTimeout(()=>{c()},15e3)},u=async()=>{a.current&&clearTimeout(a.current),d(),a.current=setTimeout(()=>{n()},15e3)};return t.useEffect(()=>{const s=async i=>{if(i!==null){const m=i.length;for(let p=0;p<m;p++)a=await new Promise(f=>setTimeout(f,15e3)),n(),p==i.length-1&&s(i)}};r&&s(r)},[r]),e.jsx(e.Fragment,{children:e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:` w-full h-[300px] md:h-[500px] flex 
          overflow-hidden z-0
     ...
     from-black/60 to-transparent`}),e.jsxs("div",{className:"z-[300]",children:[e.jsx("button",{onMouseDown:u,className:`block absolute top-0 bottom-0 
          ...
          max-w-[800px] mx-auto w-full z-[300]`,children:e.jsx(b,{})})})]})})},A=[{title:"Restaurants",link:"/web/search?q=restaurants",icon:e.jsx(q,{})},{title:"Shopping",link:"/web/search?q=shopping",icon:e.jsx(N,{})},{title:"Nightlife",link:"/web/search?q=nightlife",icon:e.jsx(w,{})},{title:"Active Life",link:"/web/search?q=nightlife",icon:e.jsx(R,{})},{title:"Beauty & Spa",link:"/web/search?q=beauty and spa",icon:e.jsx(y,{})},{title:"Automotive",link:"/web/search?q=automotive",icon:e.jsx(C,{})},{title:"Home Services",link:"/web/search?q=home service",icon:e.jsx(B,{})},{title:"Real Estate",link:"/web/search?q=real estate",icon:e.jsx(z,{})}],G=()=>e.jsx("div",{className:"w-full relative mt-[50px] px-[15px]",children:e.jsxs("div",{className:"max-w-[1100px] mx-auto w-full",children:[e.jsx("div",{className:`relative font-sans text-2xl
