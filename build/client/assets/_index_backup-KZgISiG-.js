import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,S as w}from"./Footer-Dw-lMAin.js";import{B as j,a as v,R as N,C as k,G as S,b as R,c as y,F as B,d as z,M as C}from"./lib-CqXDXTdR.js";import{r as t,L as h}from"./components-CCwaTRgT.js";import{W as q,U as H,M as E}from"./UserMenu-AQF0I1QO.js";import{H as F}from"./Hamburger-D_wSp6eh.js";import"./LatestStarRating-Do6xPgZu.js";import"./AuthContext-lT-nqNxr.js";import"./index-1btvZYIC.js";const K=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function O(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
