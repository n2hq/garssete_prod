import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-Bcf3BXrF.js";import{L as f,r as t}from"./components-qdL6XBti.js";import{r as w,B as N,a as k,R as S,C as R,G as T,a3 as y,c as B,F as E,d as H,M as z}from"./lib-CAoDFbwa.js";import{H as _}from"./Hamburger-DH1LfVLu.js";import{U as C,M}from"./UserMenu-Bq8B3kGt.js";import{S as q,R as F,F as G}from"./Footer-BIPKmOdN.js";import{T as L}from"./TopAd-D4AdkyOi.js";import"./AuthContext-392XTwOE.js";import"./WhiteLogo-_cYqv2B8.js";import"./index-Ddk6WeWA.js";import"./LatestStarRating-Dtk0rzjn.js";import"./json-26l_Net_.js";const A=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((r,n)=>e.jsx("div",{children:e.jsx(f,{to:`${r.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:r.title})]})})},n))})]})}),re=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],ae=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(D,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(F,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(G,{})]});export{ae as default,re as meta};
