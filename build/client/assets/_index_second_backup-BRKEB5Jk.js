import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-BItzE1mi.js";import{L as f,r as t}from"./components-DN9bEK-g.js";import{k as w,F as N}from"./lib-Ddo6mlOM.js";import{U as k,H as S,M as R,C as T,G as y}from"./UserMenu-BvdDF2nK.js";import{B,a as E,c as H,d as z}from"./index-TQUiWdzl.js";import{S as _,R as C,F as M}from"./Footer-DQcG5hcA.js";import{c as q,M as F}from"./index-BkU2dnIz.js";import{R as G}from"./index-MkRal4zH.js";import{T as L}from"./TopAd-Cm4tYdQx.js";import"./index-3pbSN0sp.js";import"./AuthContext-Cppis7Ha.js";import"./WhiteLogo-CBJbnFuS.js";import"./LatestStarRating-D2KbueAY.js";const A=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
                cursor-pointer tracking-tight relative
                top-[-1px] font-poppins`,children:w()})}),D=()=>{const[r]=t.useState(1),[n,m]=t.useState(""),[a,l]=t.useState(!1),[i,o]=t.useState(!1),[x,j]=t.useState(!1),h=()=>o(!0),u=()=>o(!1);return t.useEffect(()=>{const p=()=>{window.scrollY>=r&&l(!0),window.scrollY<r&&l(!1)};window.onscroll=()=>p()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        flex place-content-between h-full`,children:[e.jsx("div",{className:`font-bold font-sans 
          flex place-items-center text-2xl w-fit
           `,children:e.jsx(A,{})}),e.jsx("div",{className:`hidden place-items-center
                     lg:flex  w-full`,children:e.jsx(f,{to:"/web/search",children:"Search"})}),e.jsx("div",{className:"flex place-items-center ",children:e.jsxs("div",{className:"flex place-items-center gap-4",children:[e.jsx(k,{theme:"dark"}),e.jsx(S,{theme:"dark",openNav:h,navBg:x})]})})]})}),e.jsx(R,{showNav:i,closeNav:u})]})},d=[{img:"/images/hero/man_with_reading_glasses.jpg"},{img:"/images/hero/mobile_device.jpg"},{img:"/images/hero/business_man.jpg"},{img:"/images/hero/realtor_in_dark.jpg"},{img:"/images/hero/lady_eating.jpg"},{img:"/images/hero/bedroom_furniture.jpg"},{img:"/images/hero/perfume.jpg"}],X=()=>{const[r,n]=t.useState(0),m=t.useRef(0);t.useRef(0);const[a,l]=t.useState(null);let i=t.useRef(null);const o=s=>{m.current=s.touches[0].clientX},x=s=>{const c=s.changedTouches[0].clientX,v=m.current-c;v>50?n(g=>(g+1)%d.length):v<-50&&n(g=>(g-1+d.length)%d.length)};t.useEffect(()=>{l(d)},[]);const j=()=>{n(s=>s===0?a.length-1:s-1)},h=()=>{n(s=>s===a.length-1?0:s+1)},u=async()=>{i.current&&clearTimeout(i.current),h(),i.current=setTimeout(()=>{},15e3)},p=async()=>{i.current&&clearTimeout(i.current),j(),i.current=setTimeout(()=>{},15e3)};return t.useEffect(()=>{},[a]),e.jsx(e.Fragment,{children:e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:` w-full h-screen flex 
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((r,n)=>e.jsx("div",{children:e.jsx(f,{to:`${r.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:r.title})]})})},n))})]})}),ae=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],ie=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(D,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(C,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(M,{})]});export{ie as default,ae as meta};
