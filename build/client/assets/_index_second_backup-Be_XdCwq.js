import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-D_CIR8dl.js";import{L as f,r as t}from"./components-BgCvqN9p.js";import{Z as w,B as N,a as k,R as S,C as R,G as T,a6 as y,c as B,F as E,d as H,M as z}from"./lib-8z_1mPj7.js";import{H as _}from"./Hamburger-DMdqh19Y.js";import{U as C,M}from"./UserMenu-BwjVdiH0.js";import{S as q,R as F,F as G}from"./Footer-Ca-o4ZNG.js";import{T as L}from"./TopAd-CPbxN4Wu.js";import"./AuthContext-Y60KU9R0.js";import"./index-ByZGKDc4.js";import"./LatestStarRating-CHVKA1XG.js";const A=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((a,n)=>e.jsx("div",{children:e.jsx(f,{to:`${a.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:a.title})]})})},n))})]})}),te=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],se=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(D,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(F,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(G,{})]});export{se as default,te as meta};
