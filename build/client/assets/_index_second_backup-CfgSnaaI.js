import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-B8gf9OX2.js";import{L as f,r as t}from"./components-Bk2QJ2_x.js";import{D as w,C as N,F as k}from"./lib-B3YxGgVF.js";import{H as S}from"./Hamburger-BLiKx7P_.js";import{U as R,M as T,G as y}from"./UserMenu-CZg6XGzG.js";import{B,a as E,c as H,d as z}from"./index-CS0-_5jV.js";import{S as _,R as C,F as M}from"./Footer-Cd9wQK2d.js";import{m as q,M as F}from"./index-B5qpSsui.js";import{R as D}from"./index-B94cTHz8.js";import{T as G}from"./TopAd-CY5VM9rX.js";import"./AuthContext-DZGylfWd.js";import"./WhiteLogo-xlplX3JS.js";import"./LatestStarRating-BIkTnbRV.js";import"./json-BQCmjusd.js";const L=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
                cursor-pointer tracking-tight relative
                top-[-1px] font-poppins`,children:w()})}),A=()=>{const[r]=t.useState(1),[n,d]=t.useState(""),[a,l]=t.useState(!1),[i,o]=t.useState(!1),[x,j]=t.useState(!1),h=()=>o(!0),u=()=>o(!1);return t.useEffect(()=>{const p=()=>{window.scrollY>=r&&l(!0),window.scrollY<r&&l(!1)};window.onscroll=()=>p()},[r]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((r,n)=>e.jsx("div",{children:e.jsx(f,{to:`${r.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:r.title})]})})},n))})]})}),ie=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],ne=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(A,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(C,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(G,{}),e.jsx($,{}),e.jsx(M,{})]});export{ne as default,ie as meta};
