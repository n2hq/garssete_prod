import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as u,u as y,s as S}from"./index-BH1rD2l9.js";import{r as i,a as k,L as p}from"./components-Bk2QJ2_x.js";import{w as P,W as R}from"./WhiteLogo-CSa_5nI8.js";import{u as C}from"./AuthContext-Ck9o8HK1.js";import{u as E}from"./NotificationContext-DqLWGrIo.js";import{z as h}from"./lib-C5h13u1H.js";const L=u.object({username:u.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),z=()=>{var x;const[W,f]=i.useState(null),o=C();if(!o)return null;const[A,l]=i.useState(!1),n=E();k();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=a=>{let d=a.target.value,r=a.target.name;f(s=>({...s,[r]:d}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",h(s))):(n.alertCancel("",h(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:T,watch:V,setError:$,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        ...
        bg-cover bg-center min-h-screen flex place-content-center `,children:e.jsx(z,{})}),I=()=>e.jsx("div",{children:e.jsx(F,{})});export{I as default};
