import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as u,u as y,s as S}from"./index-CORT_df8.js";import{r as i,a as k,L as p}from"./components-DN9bEK-g.js";import{w as P,W as R}from"./WhiteLogo-D1-cdhdo.js";import{u as C}from"./AuthContext-CWcYzizb.js";import{u as E}from"./NotificationContext-EjtJgN-p.js";import{t as h}from"./lib-DckcjCnC.js";const L=u.object({username:u.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),F=()=>{var x;const[A,f]=i.useState(null),o=C();if(!o)return null;const[T,a]=i.useState(!1),n=E();k();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=l=>{let d=l.target.value,r=l.target.name;f(s=>({...s,[r]:d}))},j=async l=>{a(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:l.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(a(!1),n.alertCancel("",h(s))):(n.alertCancel("",h(s)),await new Promise(c=>setTimeout(c,1e3)),a(!1),g(!0))},{register:v,handleSubmit:N,getValues:V,watch:$,setError:z,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
