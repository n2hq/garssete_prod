import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as y}from"./ResponsiveNav-CtyN_Fd6.js";import{z as d,u as S,s as k}from"./index-CLh2UBG4.js";import{r as o,b as P,L as p}from"./components-kAvIA9Ge.js";import{W as R}from"./MobileNav-CLmV9V7l.js";import{u as C,y as u}from"./index-DH32Dgz8.js";import{u as E}from"./NotificationContext-B4iz9144.js";import{w as F}from"./css-DPrdeFsB.js";const L=d.object({username:d.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),W=()=>{var m;const[T,h]=o.useState(null),f=C(),[V,l]=o.useState(!1),n=E();P();const[i,g]=o.useState(!1),b="Please check email provided to continue.",w=a=>{let x=a.target.value,r=a.target.name;h(s=>({...s,[r]:x}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await f.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",u(s))):(n.alertCancel("",u(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:$,watch:z,setError:B,formState:{errors:t,isSubmitting:H}}=S({defaultValues:{},resolver:k(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        ...
        bg-cover bg-center min-h-screen flex place-content-center`,children:e.jsx(W,{})}),Q=()=>e.jsxs("div",{children:[e.jsx(y,{theme:"light"}),e.jsx(A,{})]});export{Q as default};
