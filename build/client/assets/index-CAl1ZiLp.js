import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{u as y,s as S}from"./zod-CNQGm8c5.js";import{r as i,u as P,L as u}from"./components-CooaLra5.js";import{w as k,W as R}from"./WhiteLogo-BB3rOQpa.js";import{u as C}from"./AuthContext-sXgBTjvG.js";import{u as E}from"./NotificationContext-CWEVbJtj.js";import{P as p}from"./lib-xHzxSWIM.js";import{z as h}from"./index-C4bLmoCR.js";const L=h.object({username:h.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),F=()=>{var x;const[z,f]=i.useState(null),o=C();if(!o)return null;const[A,a]=i.useState(!1),n=E();P();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=l=>{let d=l.target.value,r=l.target.name;f(s=>({...s,[r]:d}))},j=async l=>{a(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:l.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(a(!1),n.alertCancel("",p(s))):(n.alertCancel("",p(s)),await new Promise(c=>setTimeout(c,1e3)),a(!1),g(!0))},{register:v,handleSubmit:N,getValues:T,watch:V,setError:$,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[80px] mb-[20px] z-[10] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:N(j),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    ...
                    px-[10px] `,children:[e.jsx("div",{className:k,children:e.jsx(R,{})}),e.jsx("div",{className:`text-[22px] text-center
        ...
        bg-cover bg-center min-h-screen flex place-content-center `,children:e.jsx(F,{})}),K=()=>e.jsx("div",{children:e.jsx(W,{})});export{K as default};
