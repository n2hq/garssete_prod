import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as u,u as y,s as S}from"./index-tW0-2oYE.js";import{r as i,a as k,L as p}from"./components-_iSq0a46.js";import{w as P,W as R}from"./WhiteLogo-CdpZOKeo.js";import{u as C}from"./AuthContext-DopcVI1K.js";import{u as E}from"./NotificationContext-DoOVhrLn.js";import{A as h}from"./lib-BHrocJru.js";const L=u.object({username:u.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),A=()=>{var x;const[W,f]=i.useState(null),o=C();if(!o)return null;const[z,l]=i.useState(!1),n=E();k();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=a=>{let d=a.target.value,r=a.target.name;f(s=>({...s,[r]:d}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",h(s))):(n.alertCancel("",h(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:T,watch:V,setError:$,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
                        ...
                        place-items-center mt-[25px]`,children:e.jsx("button",{type:"submit",className:`w-[85%] bg-blue-600
                            ...
                            rounded`,children:w}),e.jsx("div",{className:`w-full flex flex-col 
                                            ...
                                            place-items-center mt-[20px]`,children:e.jsx(p,{to:"/web/signup",className:"w-[85%]",children:e.jsxs("button",{className:`w-full 
                                                ...
                                                text-blue-700 hover:bg-gray-100`,children:["No account yet? ",e.jsx("span",{className:"text-black",children:"Create an account"})]})})})]})})})]})},F=()=>e.jsx("div",{className:`bg-white w-full 
        md:bg-[url('/images/drone.jpg')]
        bg-cover bg-center min-h-screen flex place-content-center `,children:e.jsx(A,{})}),I=()=>e.jsx("div",{children:e.jsx(F,{})});export{I as default};
