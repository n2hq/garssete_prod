import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as y}from"./ResponsiveNav-ru9WXtHt.js";import{z as d,u as S,s as k}from"./index-CLh2UBG4.js";import{r as o,b as P,L as p}from"./components-kAvIA9Ge.js";import{w as R,W as C}from"./MobileNav-DSoEjn7G.js";import{u as E,C as u}from"./index-BXHtOMuL.js";import{u as F}from"./NotificationContext-DyVriLyu.js";const L=d.object({username:d.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),W=()=>{var m;const[T,h]=o.useState(null),f=E(),[V,l]=o.useState(!1),n=F();P();const[i,g]=o.useState(!1),b="Please check email provided to continue.",w=a=>{let x=a.target.value,r=a.target.name;h(s=>({...s,[r]:x}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await f.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",u(s))):(n.alertCancel("",u(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:$,watch:z,setError:B,formState:{errors:t,isSubmitting:H}}=S({defaultValues:{},resolver:k(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[100px] mb-[20px]  `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:N(j),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    ...
                    px-[10px] `,children:[e.jsx("div",{className:R,children:e.jsx(C,{})}),e.jsx("div",{className:`text-[22px] text-center
        ...
        bg-cover bg-center min-h-screen flex place-content-center`,children:e.jsx(W,{})}),K=()=>e.jsxs("div",{children:[e.jsx(y,{theme:"light"}),e.jsx(A,{})]});export{K as default};
