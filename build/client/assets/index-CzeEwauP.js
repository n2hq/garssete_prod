import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{u as P,s as E}from"./zod-PtQGc9r6.js";import{r as c,a as R,L as u}from"./components-CCwaTRgT.js";import{w as C,W as L}from"./WhiteLogo-BBidgNJe.js";import{u as O}from"./AuthContext-Crea6u0m.js";import{u as F}from"./NotificationContext-Bgz3_41l.js";import{Y as p}from"./lib-B-TVjvlj.js";import{z as h}from"./index-C4bLmoCR.js";import{u as W}from"./OperationContext-CaoUEJma.js";const z=h.object({username:h.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),A=()=>{var x;const[V,f]=c.useState(null),o=O();if(!o)return null;const[$,l]=c.useState(!1);F(),R();const[i,g]=c.useState(!1),w="Please check email provided to continue.",{showOperation:b,showError:j,completeOperation:m,showSuccess:v}=W(),N=a=>{let d=a.target.value,n=a.target.name;f(s=>({...s,[n]:d}))},y=async a=>{l(!0),b("processing"),await new Promise(r=>setTimeout(r,1e3));const n={email:a.username},s=await o.resetpw(n);JSON.stringify(s).includes("Error")?(l(!1),j("Error",p(s)),m()):(v("Success",p(s)),await new Promise(r=>setTimeout(r,1e3)),m(),l(!1),g(!0))},{register:S,handleSubmit:k,getValues:B,watch:H,setError:J,formState:{errors:t,isSubmitting:M}}=P({defaultValues:{},resolver:E(z)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
                        ...
                        place-items-center mt-[25px]`,children:e.jsx("button",{type:"submit",className:`w-[85%] bg-blue-600
                            ...
                            rounded`,children:w}),e.jsx("div",{className:`w-full flex flex-col 
                                            ...
                                            place-items-center mt-[20px]`,children:e.jsx(u,{to:"/web/signup",className:"w-[85%]",children:e.jsxs("button",{className:`w-full 
                                                ...
                                                text-blue-700 hover:bg-gray-100`,children:["No account yet? ",e.jsx("span",{className:"text-black",children:"Create an account"})]})})})]})})})]})},T=()=>e.jsx("div",{className:`bg-white w-full 
        md:bg-[url('/images/drone.jpg')]
        bg-cover bg-center min-h-screen flex place-content-center `,children:e.jsx(A,{})}),Z=()=>e.jsx("div",{children:e.jsx(T,{})});export{Z as default};
