import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as k}from"./ResponsiveNav-CGQABT1g.js";import{z as a,u as P,s as C}from"./index-CLh2UBG4.js";import{r,b as E,L as j}from"./components-kAvIA9Ge.js";import{W as L}from"./MobileNav-8pObxhVZ.js";import{u as _}from"./NotificationContext-BQR_c_qI.js";import{w as F}from"./css-DPrdeFsB.js";import{k as R}from"./index-iHLp7q33.js";const $=/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/,A=a.object({email:a.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"}),password:a.string({message:"Please enter a password"}).min(8,"Password must be at least 8 characters").regex($,"Please enter a valid password"),first_name:a.string({message:"Please enter your first name"}).min(1,{message:"First name must be at least 1 character"}).max(50,{message:"First name must be at most 50 characters"}),lastname:a.string({message:"Please enter your last name"}).min(1,{message:"Last name must be at least 1 character"}).max(50,{message:"Last name must be at most 50 characters"})}),W=()=>{var p,u,h,g;const[z,v]=r.useState(null),[G,o]=r.useState(!1),i=_();E();const[x,N]=r.useState(!1),d="Signup is successful! Please check email provided to complete signup.",l=c=>{let f=c.target.value,w=c.target.name;v(m=>({...m,[w]:f}))},y=async c=>{o(!0),i.notify("",""),await new Promise(t=>setTimeout(t,1e3));const m="https://tynk.cc"+"/api/user";try{const t=await fetch(m,{method:"POST",headers:R,body:JSON.stringify(c)});if(t.ok)i.alertCancel("",d),N(!0);else{var b=await t.json();throw new Error(`Error Code: ${t.status} - ${b.message||b.error}`)}}catch(t){i.alertCancel("",t.message);return}finally{o(!1)}},{register:n,handleSubmit:S,getValues:T,watch:U,setError:V,formState:{errors:s,isSubmitting:H}}=P({defaultValues:{},resolver:C(A)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[100px] mb-[20px] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:S(y),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    ...
                    px-[10px]`,children:[e.jsx("div",{className:F,children:e.jsx(L,{})}),e.jsx("div",{className:`text-[22px] text-center
                        ...
                        place-items-center mt-[15px]`,children:[e.jsx("input",{...n("email",{onChange:l}),placeholder:"Email address",type:"text",className:`border-b w-[85%]
                                ...
                                leading-[1.2em] mt-1`,children:(h=s==null?void 0:s.email)==null?void 0:h.message})]}),e.jsxs("div",{className:`w-full flex flex-col 
                        place-items-center mt-[15px] `,children:[e.jsx("input",{...n("password",{onChange:l}),placeholder:"Password",type:"password",className:`border-b w-[85%]
                                ...
                                leading-[1.2em] mt-1`,children:(g=s==null?void 0:s.password)==null?void 0:g.message})]}),e.jsx("div",{className:`w-full flex flex-col 
        ...
        bg-cover bg-center min-h-screen flex place-content-center`,children:e.jsx(W,{})}),Q=()=>e.jsxs("div",{children:[e.jsx(k,{theme:"light"}),e.jsx(B,{})]});export{Q as default};
