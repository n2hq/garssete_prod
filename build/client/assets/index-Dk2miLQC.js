import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as i,u as v,s as N}from"./index-CORT_df8.js";import{r as u,a as S,L as g}from"./components-DN9bEK-g.js";import{u as y}from"./AuthContext-C6LyRwiZ.js";import{u as P}from"./NotificationContext-D40QLUsT.js";import{w as k,W as E}from"./WhiteLogo-DM7nNDC1.js";import{f as C}from"./lib-NVLtleF7.js";const F=/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/,L=i.object({username:i.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"}),password:i.string({message:"Please enter a password"}).min(8,"Password must be at least 8 characters").regex(F,"Please enter a valid password")}),W=()=>{const[T,h]=u.useState(null),c=y();if(!c)return null;const{signin:f}=c,[_,o]=u.useState(!1),a=P(),w=S(),x=t=>{let l=t.target.value,n=t.target.name;h(d=>({...d,[n]:l}))},b=async t=>{o(!0),a.notify(),await new Promise(r=>setTimeout(r,1e3));const l=t.username,n=t.password,p=await f({email:l,password:n});p===!0?(a.cancel(),w("/")):a.alertCancel("Complete Your Signup",p.message),await new Promise(r=>setTimeout(r,1e3)),o(!1)},{register:m,handleSubmit:j,getValues:z,watch:D,setError:I,formState:{errors:s,isSubmitting:V}}=v({defaultValues:{},resolver:N(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
