import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{u as y,s as S}from"./zod-PtQGc9r6.js";import{r as i,a as k,L as u}from"./components-CCwaTRgT.js";import{w as P,W as R}from"./WhiteLogo-hx6VZQD6.js";import{u as C}from"./AuthContext-C7k3lHjW.js";import{u as E}from"./NotificationContext-BVMvs2cM.js";import{V as p}from"./lib-d5lyMBXU.js";import{z as h}from"./index-C4bLmoCR.js";const L=h.object({username:h.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),F=()=>{var x;const[W,f]=i.useState(null),o=C();if(!o)return null;const[z,l]=i.useState(!1),n=E();k();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=a=>{let d=a.target.value,r=a.target.name;f(s=>({...s,[r]:d}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",p(s))):(n.alertCancel("",p(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:A,watch:T,setError:$,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
