import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{u as L,s as _}from"./zod-PtQGc9r6.js";import{r as m,a as C,L as j}from"./components-CCwaTRgT.js";import{w as F,W as A}from"./WhiteLogo-E4eqNMj1.js";import{u as O}from"./NotificationContext-u_i63fMA.js";import{E as W,m as $}from"./lib-CC-22j43.js";import{z as a}from"./index-C4bLmoCR.js";import{u as B}from"./OperationContext-CaoUEJma.js";const R=/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/,T=a.object({email:a.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"}),password:a.string({message:"Please enter a password"}).min(8,"Password must be at least 8 characters").regex(R,"Please enter a valid password"),first_name:a.string({message:"Please enter your first name"}).min(1,{message:"First name must be at least 1 character"}).max(50,{message:"First name must be at most 50 characters"}),lastname:a.string({message:"Please enter your last name"}).min(1,{message:"Last name must be at least 1 character"}).max(50,{message:"Last name must be at most 50 characters"})}),z=()=>{var p,u,g,h;const[U,v]=m.useState(null),[V,r]=m.useState(!1);O(),C();const[o,N]=m.useState(!1),x="Signup is successful! Please check email provided to complete signup.",{showOperation:y,showError:S,completeOperation:d,showSuccess:E}=B(),l=i=>{let f=i.target.value,w=i.target.name;v(c=>({...c,[w]:f}))},P=async i=>{r(!0),y("processing"),await new Promise(t=>setTimeout(t,1e3));const c="https://edition.garssete.com"+"/api/user";try{const t=await fetch(c,{method:"POST",headers:$,body:JSON.stringify(i)});if(t.ok)E("Success",x),d(),N(!0);else{var b=await t.json();throw new Error(`${b.message||b.error}`)}}catch(t){S("Error",t.message),d();return}finally{r(!1)}},{register:n,handleSubmit:k,getValues:G,watch:H,setError:I,formState:{errors:s,isSubmitting:J}}=L({defaultValues:{},resolver:_(T)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[80px] mb-[20px] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:k(P),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    ...
                    px-[10px]`,children:[e.jsx("div",{className:F,children:e.jsx(A,{})}),e.jsx("div",{className:`text-[22px] text-center
                        ...
                        place-items-center mt-[20px]`,children:e.jsx(j,{to:"/web/signin",className:"w-[85%]",children:e.jsxs("button",{className:`w-full 
                            ...
                            text-blue-700 hover:bg-gray-100`,children:["Alread have an account? ",e.jsx("span",{children:"Sign in"})]})})})]})})})]})},M=()=>e.jsx("div",{className:`bg-white w-full 
        md:bg-[url('/images/mobiletab.jpg')]
        bg-cover bg-center min-h-screen flex place-content-center`,children:e.jsx(z,{})}),se=()=>e.jsx("div",{children:e.jsx(M,{})});export{se as default};
