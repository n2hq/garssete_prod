import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as u,u as y,s as S}from"./index-CORT_df8.js";import{r as i,a as k,L as p}from"./components-DN9bEK-g.js";import{w as P,W as R}from"./WhiteLogo-DM7nNDC1.js";import{u as C}from"./AuthContext-C6LyRwiZ.js";import{u as E}from"./NotificationContext-D40QLUsT.js";import{t as f}from"./lib-NVLtleF7.js";const L=u.object({username:u.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"})}),F=()=>{var x;const[z,h]=i.useState(null),o=C();if(!o)return null;const[A,l]=i.useState(!1),n=E();k();const[m,g]=i.useState(!1),w="Please check email provided to continue.",b=a=>{let d=a.target.value,r=a.target.name;h(s=>({...s,[r]:d}))},j=async a=>{l(!0),n.notify(),await new Promise(c=>setTimeout(c,1e3));const r={email:a.username},s=await o.resetpw(r);JSON.stringify(s).includes("Error")?(l(!1),n.alertCancel("",f(s))):(n.alertCancel("",f(s)),await new Promise(c=>setTimeout(c,1e3)),l(!1),g(!0))},{register:v,handleSubmit:N,getValues:T,watch:V,setError:$,formState:{errors:t,isSubmitting:B}}=y({defaultValues:{},resolver:S(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[100px] mb-[20px] z-[10] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:N(j),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
        ...
        bg-cover bg-center min-h-screen flex place-content-center relative`,children:e.jsx(F,{})}),I=()=>e.jsx("div",{children:e.jsx(W,{})});export{I as default};
