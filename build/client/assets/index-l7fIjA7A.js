import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as i,u as v,s as N}from"./index-tW0-2oYE.js";import{r as u,a as S,L as g}from"./components-_iSq0a46.js";import{u as y}from"./AuthContext-DopcVI1K.js";import{u as k}from"./NotificationContext-DoOVhrLn.js";import{w as P,W as E}from"./WhiteLogo-CdpZOKeo.js";import{k as C}from"./lib-BHrocJru.js";const F=/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/,L=i.object({username:i.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"}),password:i.string({message:"Please enter a password"}).min(8,"Password must be at least 8 characters").regex(F,"Please enter a valid password")}),W=()=>{const[T,h]=u.useState(null),o=y();if(!o)return null;const{signin:f}=o,[_,c]=u.useState(!1),a=k(),w=S(),x=t=>{let l=t.target.value,n=t.target.name;h(d=>({...d,[n]:l}))},b=async t=>{c(!0),a.notify(),await new Promise(r=>setTimeout(r,1e3));const l=t.username,n=t.password,p=await f({email:l,password:n});p===!0?(a.cancel(),w("/")):a.alertCancel("Complete Your Signup",p.message),await new Promise(r=>setTimeout(r,1e3)),c(!1)},{register:m,handleSubmit:j,getValues:z,watch:D,setError:I,formState:{errors:s,isSubmitting:V}}=v({defaultValues:{},resolver:N(L)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[80px] mb-[20px] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:j(b),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    flex flex-col place-items-center pt-[40px] pb-[40px]
                    px-[10px] `,children:[e.jsx("div",{className:P,children:e.jsx(E,{})}),e.jsx("div",{className:`text-[22px] text-center
