import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{z as a,u as P,s as k}from"./index-CORT_df8.js";import{r,a as E,L as j}from"./components-DN9bEK-g.js";import{w as C,W as L}from"./WhiteLogo-BVe8Lk7p.js";import{u as _}from"./NotificationContext-C_vKrWZf.js";import{i as F,h as $}from"./lib-Drj-iocb.js";const A=/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/,T=a.object({email:a.string({message:"Please enter an email"}).min(7,{message:"Email must be greater than 7 characters"}).email({message:"Please enter a valid email"}),password:a.string({message:"Please enter a password"}).min(8,"Password must be at least 8 characters").regex(A,"Please enter a valid password"),first_name:a.string({message:"Please enter your first name"}).min(1,{message:"First name must be at least 1 character"}).max(50,{message:"First name must be at most 50 characters"}),lastname:a.string({message:"Please enter your last name"}).min(1,{message:"Last name must be at least 1 character"}).max(50,{message:"Last name must be at most 50 characters"})}),W=()=>{var p,u,g,h;const[z,v]=r.useState(null),[M,o]=r.useState(!1),c=_();E();const[x,N]=r.useState(!1),d="Signup is successful! Please check email provided to complete signup.",l=i=>{let f=i.target.value,b=i.target.name;v(m=>({...m,[b]:f}))},y=async i=>{o(!0),c.notify("",""),await new Promise(s=>setTimeout(s,1e3));const m="https://edition.garssete.com"+"/api/user";try{const s=await fetch(m,{method:"POST",headers:$,body:JSON.stringify(i)});if(s.ok)c.alertCancel("",d),N(!0);else{var w=await s.json();throw new Error(`Error Code: ${s.status} - ${w.message||w.error}`)}}catch(s){c.alertCancel("",s.message);return}finally{o(!1)}},{register:n,handleSubmit:S,getValues:U,watch:V,setError:G,formState:{errors:t,isSubmitting:H}}=P({defaultValues:{},resolver:k(T)});return e.jsxs("div",{className:`w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[80px] mb-[20px] `,children:[e.jsx("div",{className:"hidden lg:block "}),e.jsx("div",{className:"place-content-center flex lg:place-content-end col-span-12 md:col-span-1",children:e.jsx("form",{onSubmit:S(y),children:e.jsxs("div",{className:`w-[350px] bg-white h-full rounded-2xl
                    ...
                    px-[10px]`,children:[e.jsx("div",{className:C,children:e.jsx(L,{})}),e.jsx("div",{className:`text-[22px] text-center
                        ...
                        place-items-center mt-[20px]`,children:e.jsx(j,{to:"/web/signin",className:"w-[85%]",children:e.jsxs("button",{className:`w-full 
                            ...
                            text-blue-700 hover:bg-gray-100`,children:["Alread have an account? ",e.jsx("span",{children:"Sign in"})]})})})]})})})]})},B="/images/mobiletab.jpg",R=()=>e.jsx("div",{className:`bg-white w-full 
        md:bg-[url('${B}')]
        bg-cover bg-center min-h-screen flex place-content-center`,children:e.jsx(W,{})}),K=()=>e.jsx("div",{children:e.jsx(R,{})});export{K as default};
