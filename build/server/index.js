...
const CardTitle = (cardTitle) => {
  return /* @__PURE__ */ jsx("div", { className: `font-semibold mb-2 text-2xl flex
        place-content-between border-b pb-3`, children: /* @__PURE__ */ jsx(Link, { to: `${cardTitle.baseUrl}${cardTitle.guid}`, children: cardTitle.children }) });
};
const index$i = () => {
  const auth = useAuth();
  if (!auth) {
...
const index$9 = () => {
  ...
  return /* @__PURE__ */ jsx(AccountLayout, { children: /* @__PURE__ */ jsx(ContentLayout, { title: "Update Business", children: data && /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `bg-blue-100 w-full px-2 py-2
                            flex place-content-end rounded-lg`, children: /* @__PURE__ */ jsx(
      Link,
      {
