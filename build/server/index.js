...
const Card = ({ listing }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `bg-blue-50/50 w-full h-auto md:rounded-md shadow-md overflow-hidden border  hover:bg-white hover:shadow-lg`, children: [
