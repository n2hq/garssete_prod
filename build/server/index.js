  ...
  return /* @__PURE__ */ jsx("div", { className: ` px-[0px] md:px-0 bg-white`, children: /* @__PURE__ */ jsxs("div", { className: ` w-full md:rounded-xl overflow-hidden shadow-lg`, children: [
    /* @__PURE__ */ jsx("a", { href: `/${userId}`, children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: `w-full h-full top-0 left-0 bg-black/0 absolute flex place-items-center place-content-center  `, children: !bgimgsrc && /* @__PURE__ */ jsxs("div", { className: `flex place-items-end mr-2 mb-4 place-content-end w-full h-full font-light text-white/50 text-[17px]`, children: [
            listing == null ? void 0 : listing.title,
            "."
          ] }) }),
