...
const loader$p = async ({ request, params }) => {
  try {
    ...
    let sqlc = `SELECT
                ...
                LIMIT 50`;
    let rawdata = await query(sqlc, [criteria, criteria, criteria]);
    if (criteria === "" || criteria === null || criteria === void 0) {
