...
const BusinessPhrases = ({ listing }) => {
  ...
  useEffect(() => {
    ...
    if (listing !== null) {
      convertToList(listing == null ? void 0 : listing.business_phrases);
    }
  }, [listing]);
  return /* @__PURE__ */ jsxs("div", { className: "mt-12", children: [
    /* @__PURE__ */ jsx(ComponentTitle, { title: "Business Phrases" }),
    /* @__PURE__ */ jsx("div", { className: `flex gap-3 flex-wrap`, children: phrasesList.map((phrase, index2) => {
      return /* @__PURE__ */ jsx("span", { className: `bg-blue-50 px-2 border py-1 border-gray-300 hover:shadow-md cursor-move`, children: phrase });
    }) })
  ] });
};
const Products = ({ listing }) => {
  ...
  useEffect(() => {
    const convertToList = (phrases) => {
      const productList2 = phrases.split(",").map((item) => item.trim());
      setProductList(productList2);
    };
    if (listing !== null) {
      convertToList(listing == null ? void 0 : listing.products);
    }
  }, [listing]);
  return /* @__PURE__ */ jsxs("div", { className: "mt-12", children: [
    /* @__PURE__ */ jsx(ComponentTitle, { title: "Products" }),
    /* @__PURE__ */ jsx("div", { className: `flex gap-3 flex-wrap`, children: productList.map((product, index2) => {
      return /* @__PURE__ */ jsx("span", { className: `bg-blue-50 px-2 border py-1 border-gray-300 hover:shadow-md cursor-move`, children: product });
    }) })
  ] });
};
const Services = ({ listing }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-12", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `flex gap-3 flex-wrap`, children: serviceList.map((service, index2) => {
      return /* @__PURE__ */ jsx("span", { className: `bg-blue-50 px-2 border py-1 border-gray-300 hover:shadow-md cursor-move`, children: service });
    }) })
  ] });
};
