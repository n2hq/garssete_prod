...
const SrchBarHome = () => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: ` bg-[blue] text-white  fixed top-0 left-0 w-full z-[1000] shadow-lg shadow-black/30`, style: { height: `${appConfig.NAVBAR_HEIGHT}px` }, children: [
    /* @__PURE__ */ jsx(
      MobileNav,
      {
        showNav,
