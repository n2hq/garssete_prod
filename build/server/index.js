...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex gap-2 mt-2 w-full border-t-4 border-blue-700 pt-2`, children: [
