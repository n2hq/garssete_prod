...
const BusinessMenu = ({ title, guid, userGuid, setIsOpen }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: " w-fit   z-[1000] ", children: /* @__PURE__ */ jsxs("div", { className: `relative`, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `${showSettings ? "block" : "hidden"} absolute w-[180px] top-[50px] rounded-lg z-[10000] text-black
                border-[1px] border-gray-100 bg-white shadow-lg right-[20px] `, children: /* @__PURE__ */ jsx("div", { className: "divide-y-[1px] divide-gray-500/20 ", children: settingsLinks$1.map((item, index2) => {
