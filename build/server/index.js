...
const SrchNavbar = () => {
  ...
  const closeNav = () => setShowNav(false);
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { className: ` bg-[#001e5a] text-white  fixed top-0 left-0 w-full z-[10000] shadow-sm`, style: { height: `${appConfig.NAVBAR_HEIGHT}px` }, children: [
      /* @__PURE__ */ jsx(
        MobileNav,
        {
          showNav,
