...
const SrchNavbar = () => {
  ...
  const closeNav = () => setShowNav(false);
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: ` bg-blue-900 text-white  fixed top-0 left-0 w-full z-[10000] shadow-xl px-4 sm:px-6`, style: { height: `${appConfig.NAVBAR_HEIGHT}px` }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-full mx-auto flex items-center justify-between h-full gap-4", children: [
