...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex gap-2 mt-2`, children: [
    /* @__PURE__ */ jsx("div", { className: `bg-white w-[90px] min-w-[90px] h-[90px] rounded-none relative overflow-hidden hidden md:block`, children: /* @__PURE__ */ jsx(
      "img",
      {
        src: profileImg,
        alt: "",
