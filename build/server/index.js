...
const BgComponent = ({ listing, user, businessProfileBgData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative`, children: [
    /* @__PURE__ */ jsxs("div", { className: "relative bg-gray-800 w-full h-[150px] z-[40]  overflow-hidden", children: [
      imgSrc && /* @__PURE__ */ jsx(
        "img",
        {
          src: imgSrc,
