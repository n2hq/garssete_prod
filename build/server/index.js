...
const UserMenu = ({ theme }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    ) : /* @__PURE__ */ jsx("div", { className: `rounded-full border-[1px] px-3
