...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: `h-[5px] bg-gradient-to-r from-black to-blue-500 w-full mt-2 ` }),
    /* @__PURE__ */ jsxs("div", { className: `flex gap-2 mt-2 w-full `, children: [
