...
const FooterAlt = () => {
  return /* @__PURE__ */ jsx("div", { className: `px-[15px] bg-gray-100 pt-[50px] pb-[70px]`, children: /* @__PURE__ */ jsxs("div", { className: `max-w-[1100px] mx-auto w-full`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `mt-3 font-poppins font-[300] grid grid-cols-1 md:grid-cols-12 flex flex-col place-items-center text-center md:place-items-start md:text-left`, children: [
...
const ProfileBg = ({ listing, user, userProfileBgData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative`, children: [
    /* @__PURE__ */ jsxs("div", { className: `bg-black w-full h-[200px] relative shadow-lg text-white flex place-items-center place-content-center flex-col`, children: [
      imgconst === "" && "Add Photo.",
      /* @__PURE__ */ jsx(
        "img",
        {
...
const BgComponent = ({ listing, user, businessProfileBgData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative`, children: [
    /* @__PURE__ */ jsxs("div", { className: "relative bg-gray-600 w-full h-[200px] z-[40] shadow-lg text-white flex place-items-center place-content-center flex-col", children: [
      imgSrc === "" && "Add Photo.",
      imgSrc && /* @__PURE__ */ jsx(
        "img",
        {
...
const ResetPasswordForm$1 = ({ guid }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `w-[80%] h-fit grid grid-cols-1 lg:grid-cols-2
        mt-[100px] mb-[20px]  `, children: [
    /* @__PURE__ */ jsx("div", { className: `hidden lg:block ` }),
    /* @__PURE__ */ jsx("div", { className: `place-content-center flex lg:place-content-end col-span-12 md:col-span-1`, children: /* @__PURE__ */ jsx("form", { id: "rspw", onSubmit: handleSubmit(handleResetPassword), children: /* @__PURE__ */ jsxs("div", { className: `w-[350px] bg-white h-full rounded-2xl
                    flex flex-col place-items-center pt-[40px] pb-[40px]
                    px-[10px] `, children: [
      /* @__PURE__ */ jsx("div", { className: whiteLogoColor, children: /* @__PURE__ */ jsx(WhiteLogo, {}) }),
      /* @__PURE__ */ jsx("div", { className: `text-[22px] text-center
