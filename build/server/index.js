...
const StringToListMaker = ({ phrasesString }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `flex gap-3 flex-wrap`, children: phrasesList.map((phrase, index2) => {
    return /* @__PURE__ */ jsx("span", { className: `bg-blue-50 px-2 border py-1 border-gray-300 hover:shadow-none cursor-move
                        rounded-full shadow-sm shadow-gray-500`, children: phrase });
  }) });
};
