...
const RatingDisplay = ({ data }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `md:border py-[12px] px-[12px] md:mb-3  
        rounded bg-blue-100`, children: /* @__PURE__ */ jsxs("div", { className: `flex place-content-between gap-1
                `, children: [
