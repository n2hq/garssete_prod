...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex gap-2 mt-2 w-full`, children: [
    /* @__PURE__ */ jsx("div", { className: `bg-white w-[95px] min-w-[95px] h-[95px] rounded-none relative overflow-hidden hidden md:block border-gray-200 shadow-sm border-[1px]`, children: /* @__PURE__ */ jsx(
      "img",
      {
        src: profileImg,
        alt: "",
