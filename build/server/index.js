...
const SrchNavbar = () => {
  ...
  const query2 = params.get("q") || "";
  const closeNav = () => setShowNav(false);
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: ` bg-blue-100 text-black  fixed top-0 left-0 w-full z-[1000] shadow-sm`, style: { height: `${appConfig.NAVBAR_HEIGHT}px` }, children: [
    /* @__PURE__ */ jsx(
      MobileNav,
      {
        showNav,
