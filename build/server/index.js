...
const Header = ({ listing, profileImageData, operatingHoursStatus, ratingsData }) => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: `flex gap-2 mt-2 w-full  p-3 md:p-3 md:shadow-md md:rounded-xl  border border-blue-100 bg-gray-50`, children: [
    /* @__PURE__ */ jsx("div", { className: `bg-white w-[95px] min-w-[95px] h-[95px] rounded-none relative overflow-hidden hidden md:block  `, children: /* @__PURE__ */ jsx(
      "img",
      {
        src: profileImg,
        alt: "",
    ...
    /* @__PURE__ */ jsxs("div", { className: `w-full`, children: [
      /* @__PURE__ */ jsx("div", { className: `text-[19px] md:text-[24px]
                font-bold  leading-[1.2em] tracking-tight font-poppins text-blue-500`, children: listing == null ? void 0 : listing.title }),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(
                "img",
                {
                  src: imgscr,
                  alt: "",
                  className: `${!(baseListing == null ? void 0 : baseListing.image_url) ? "object-cover" : "object-scale-down"}  w-full h-full text-sm
                             z-0 bg-white`
                }
              )
            }
