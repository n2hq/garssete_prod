...
const Address$1 = ({ businessProfile }) => {
  return /* @__PURE__ */ jsx("div", { className: `w-full`, children: /* @__PURE__ */ jsxs("div", { className: `md:bg-white
            ...
            md:text-black  border-[1px] border-gray-300/70 border-t-0 rounded-t-none border-b-0`, children: [
...
const RatingDisplay = ({ data }) => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: `bg-blue-100 w-full px-3 py-3 border border-b-0 rounded-t-md grid grid-cols-2`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `flex place-content-between gap-x-1.5`, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: ``, children: /* @__PURE__ */ jsx("div", { className: `bg-blue-950 h-full w-[40px] rounded-md text-white flex place-items-center place-content-center text-[26px]`, children: Number(data == null ? void 0 : data.rating).toPrecision(2) }) })
    ] })
  ] }) });
};
const ClaimBusiness = ({ listing }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: ownerRole === "admin" && /* @__PURE__ */ jsx("div", { className: ` md:mt-0 `, children: /* @__PURE__ */ jsx(Link, { to: `/web/contact`, children: /* @__PURE__ */ jsx("div", { className: `px-3 text-[15px] text-center border border-t-0 py-[15px] rounded underline underline-offset-2  bg-blue-100 mx-[0px] md:mx-[0px]
