...
const SrchNavbar = () => {
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: ` bg-[#6f42c1] text-white  fixed top-0 left-0 w-full z-[1000] shadow-sm`, style: { height: `${appConfig.NAVBAR_HEIGHT}px` }, children: [
    /* @__PURE__ */ jsx(
      MobileNav,
      {
        showNav,
