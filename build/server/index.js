...
const BusinessDrawer = ({ isOpen, userGuid, businessGuid }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `relative`, children: /* @__PURE__ */ jsxs("div", { className: ` fixed ${navOpen}   w-[250px] h-screen bg-white shadow-lg transform transition-transform ease-in-out duration-500 `, children: [
    /* @__PURE__ */ jsx("div", { className: `p-5 border-b font-bold text-lg`, children: "Settings" }),
    /* @__PURE__ */ jsx("div", { className: ``, children: settingsLinks == null ? void 0 : settingsLinks.map((setting, index2) => {
