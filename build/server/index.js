...
const Card = ({ listing }) => {
  ...
  useEffect(() => {
    let getListingAddress = async (listing2) => {
      ...
      console.log(address);
      let addressLink2 = `https://www.google.com/maps?q=${address}&t=&z=15&ie=UTF8&iwloc=B&output=`;
      setAddressLink(addressLink2);
    };
    if (listing !== null) {
      getListingAddress(listing);
