...
const ResourceNotFound = () => {
  return /* @__PURE__ */ jsxs("div", { className: `flex place-content-center place-items-center w-full min-h-[700px] text-[13px] flex-col space-y-4`, children: [
    /* @__PURE__ */ jsx("div", { className: `font-bold text-2xl`, children: "Resource Not Found" }),
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => {
