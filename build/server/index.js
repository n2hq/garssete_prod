...
const mobileTab = "/images/mobiletab.jpg";
const SignupBody = () => {
  return /* @__PURE__ */ jsx("div", { className: `bg-white w-full 
        md:bg-[url('${mobileTab}')]
