...
const CardTitle = (cardTitle) => {
  return /* @__PURE__ */ jsx("div", { className: `font-semibold text-[19px]
        `, children: /* @__PURE__ */ jsx(Link, { to: `${cardTitle.baseUrl}${cardTitle.guid}`, children: cardTitle.children }) });
};
const index$i = () => {
  const auth = useAuth();
  if (!auth) {
