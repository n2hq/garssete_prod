      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: `flex gap-x-3`, id: "videobar", children: [
          Array.from({ length: maxSlides }, (_, i) => {
            var _a, _b, _c, _d;
            return /* @__PURE__ */ jsx("div", { children: i < maxSlides ? /* @__PURE__ */ jsx(
              "div",
              {
              ...
              "div",
              {
                className: `w-[${slideWidth}px] h-full border border-gray-500 rounded-md flex place-items-center place-content-center hover:cursor-pointer hover:bg-black/50 bg-black`,
                onClick: () => {
                  setOpenGallery(true);
                },
                children: /* @__PURE__ */ jsx("div", { className: `text-white w-1/2 text-center rounded` })
              }
            ) }, i);
          }),
          /* @__PURE__ */ jsx(
