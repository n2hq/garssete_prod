...
function Layout$1({ children }) {
  ...
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("link", { rel: "icon", href: "/gssicoblk.png?v=1", type: "image/png" }),
      /* @__PURE__ */ jsx(
        "script",
        {
          async: true,
