...
const ContentLayout = ({ children, businessGuid, data, businessProfile, title }) => {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `mt-4 bg-white px-[15px] pt-4 
