...
const CardAlt = ({ listing, index: index2 }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `px-[15px] md:px-0 bg-white`, children: /* @__PURE__ */ jsxs("div", { className: ` w-full rounded-xl overflow-hidden shadow-lg`, children: [
    /* @__PURE__ */ jsx("a", { href: `/${userId}`, children: /* @__PURE__ */ jsxs(
      "div",
      {
        className: `w-full h-[150px] bg-gray-500 bg-no-repeat bg-cover relative bg-center`,
        style: { backgroundImage: `url('${bgimgsrc}')` },
        children: [
          /* @__PURE__ */ jsx("div", { className: `w-full h-full top-0 left-0 bg-black/0 absolute` }),
